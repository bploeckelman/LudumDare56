...
import lando.systems.ld56.particles.effects.FireEffect;
...
//        audioManager.playMusic(AudioManager.Musics.introMusic);
    ...
    public void update(float delta) {
        ...
        if(Gdx.input.isButtonJustPressed(Input.Buttons.LEFT)) {
            var particleEffect = particles.effects.get(ParticleEffectType.FIRE);
            particleEffect.spawn(new FireEffect.Params(vec3.x, vec3.y));
        }
